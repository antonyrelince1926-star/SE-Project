...
export const Navbar: React.FC<NavbarProps> = ({
  ...
  const [authModalTab, setAuthModalTab] = useState<'signin' | 'register' | 'profiles'>('signin');
  ...
  const handleOpenAuth = (tab: 'signin' | 'register' | 'profiles') => {
    setAuthModalTab(tab);
          ...
          <div className="flex items-center gap-2.5 sm:gap-3">
            {user ? (
              <>
                ...
                <div
                  className="hidden md:flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/20 text-xs font-bold text-amber-600 dark:text-amber-400"
                ...
                <button
                  onClick={() => handleOpenAuth('profiles')}
                  className="hidden sm:inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold text-slate-700 dark:text-slate-200 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all border border-slate-200 dark:border-slate-700"
                  title="Switch or manage active user accounts"
                >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 sm:gap-2 px-3 sm:px-3.5 py-1.5 rounded-xl text-xs font-semibold text-white bg-indigo-600 hover:bg-indigo-700 shadow-sm shadow-indigo-500/20 active:scale-95 transition-all"
                >
                    ...
                    <div className="py-1">
                      ...
                      {user.role === 'ADMIN' && (
                        <button
                          ...
                          className="w-full text-left px-4 py-2 text-xs text-indigo-600 dark:text-indigo-400 font-medium hover:bg-indigo-50 dark:hover:bg-indigo-950/30 flex items-center gap-2"
                        >
